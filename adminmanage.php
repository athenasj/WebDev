...
//for easier access
$ID=$_SESSION['ID']; //CAPS FOR ADMIN ID
$id=$_GET['id'];
                            ...
                            //echo "The file ". basename( $_FILES["fileToUpload"]["name"]). " has been uploaded.";
                                        ...
                                        if($result){
                                                        ...
                                                        if($result && mysqli_affected_rows($con)>0){
                                                            ...
                                                            //header("Location: adminmanage.php?id=".$id);
                                                            } else {
    ...
    <body>
      ...
      <nav class="navbar navbar-default">
       ...
       <div class="container profile-edit-form" enctype="multipart/form-data">
           ...
           <?php //echo '<p class="form-desc-p">'.$message.'</p>';?>
           <p class="form-desc-p">Edit the user's profile information here.</p>
           <form class="form-horizontal" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    <input type="text" class="form-control no-border" id="profile_1_link_1" name="soc1" value="<?php echo htmlspecialchars($soc1)?>"  placeholder="User's Facebook account">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <input type="text" class="form-control no-border" id="profile_1_link_2" name="soc2" value="<?php echo htmlspecialchars($soc2)?>"  placeholder="User's Twitter account">
                </div>
            </div>

        <h1 id="account-h1">Edit Account</h1>
        <p class="form-desc-p">Edit the user's account information here.</p>
            <div class="form-group">
                <div class="col-sm-10">
            ...
            <!-- UPLOAD !!! -->
                ...
                <div class="col-sm-6">
                    <p>Select the user's profile picture.</p>
